...
public class CadastroRestauranteIT {
	...
	public void setUp() {
		...
		jsonRestauranteCorreto = ResourceUtils.lerFileEConverterToString(
				"/json/correto/restaurante-new-york-barbecue.json");
		
		jsonRestauranteSemFrete = ResourceUtils.lerFileEConverterToString(
				"/json/incorreto/restaurante-new-york-barbecue-sem-frete.json");
		
		jsonRestauranteSemCozinha = ResourceUtils.lerFileEConverterToString(
				"/json/incorreto/restaurante-new-york-barbecue-sem-cozinha.json");
		
		jsonRestauranteComCozinhaInexistente = ResourceUtils.lerFileEConverterToString(
